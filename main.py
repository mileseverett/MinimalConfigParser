...
def get_args():
    ...
    parser.add_argument('--general', type=str, required=True, help='Path to the general config file.')
    ...
    parser.add_argument('--strategy', type=str, required=True, help='Path to the strategy config file.')
